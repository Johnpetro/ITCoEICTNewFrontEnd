...
<style>
    ...
    .slide-image {
        ...
        border-radius: 8px;
        background: #f4f4f4;
        /* Light background in case of transparent images */
    }
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.services.create') }}"
                        ...
                        @foreach($services as $service)
                            <div class="slide-item">
                                ...
                                <div class="slide-actions">
                                    <a href="{{ route('admin.services.edit', $service) }}" class="btn btn-edit">Edit</a>
...
<script>
    function confirmDelete(button) {
        if (confirm("Are you sure you want to delete this director? This action cannot be undone!")) {
