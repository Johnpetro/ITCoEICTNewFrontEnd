...
<link rel="stylesheet" media="all" href="{{ asset('owl.carousel.min.css') }}" />
<link rel="stylesheet" media="all" href="{{ asset('owl.theme.default.min.css') }}" />
<link rel="stylesheet" media="all" href="{{ asset('magnific-popup.css') }}" />
<link rel="stylesheet" media="all" href="{{ asset('css/template.css') }}" />
<link rel="stylesheet" media="all" href="{{ asset('css/bootstrap.css') }}" />
<link rel="stylesheet" href="{{ asset('css/ee.css') }}" media="screen" />
<link rel="stylesheet" href="{{ asset('css/style.css') }}" media="screen" />
<link rel="stylesheet" href="{{ asset('css/update.css') }}" media="screen" />

<link href="{{ asset('images/faviconi.png') }}" rel="icon" type="image/png" />
